                ...
                <div className="grid grid-cols-2 gap-[20px] max-sm:grid-cols-1 ">
                    <div className="flex flex-col justify-between">
                        <div>
                            ...
                            <h2 className='mb-[30px] text-[42px] font-montserrat font-extrabold tracking-wider'>CONTACT</h2>
                            ...
                            <NavLink to={"mailto:info@mysite.com"} className='pb-[25px] text-[14px] font-roboto font-light block tracking-wider leading-6'>info@mysite.com</NavLink>
