...
import { eyeIcon, heroBanner, loginWave, mailIcon, personIcon, phoneIcon } from '../../assets/images/images';
                                ...
                                <form>
                                    ...
                                    <div className="mt-[15px] mb-[30px] ml-[5px]">
                                        <div className="mb-[10px] flex gap-[15px] items-start">
                                            <input type="checkbox" className='m-0 accent-black scale-150 mt-[5px]' required />
